/*
	...
	Precompiled header source for building LAME on Macintosh using CodeWarrior.
	Includes most definitions normally generated by configure in config.h,
	except for the ones that vary from subproject to subproject
*/

#define TARGET_MAC_DLL 1
...
//	The following definitions have been pulled out to specific targets'
//		pch files:
//			LAME_LIBRARY_BUILD			1 for building the DLL
//			LIBSNDFILE					1 for building with LibSndFile, applies
//											only to CLI encoder

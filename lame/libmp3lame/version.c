...
#ifdef HAVE_VCSREVISION_H
# include "vcsrevision.h"  /* LAME_VCS_REVISION, generated by the build */
#endif

#ifdef LAME_VCS_REVISION
# define LAME_VCS_REVISION_SUFFIX " " LAME_VCS_REVISION
#else
# define LAME_VCS_REVISION_SUFFIX ""
#endif
...
{                       /* primary to write screen reports */
    ...
    static /*@observer@ */ const char *const str =
        ...
        "(alpha " STR(LAME_PATCH_VERSION) LAME_VCS_REVISION_SUFFIX ", "
        __DATE__ " " __TIME__ ")";
#elif LAME_BETA_VERSION
    static /*@observer@ */ const char *const str =
        STR(LAME_MAJOR_VERSION) "." STR(LAME_MINOR_VERSION) " "
        "(beta " STR(LAME_PATCH_VERSION) LAME_VCS_REVISION_SUFFIX ", "
        __DATE__ ")";
